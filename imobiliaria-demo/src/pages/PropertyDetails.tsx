...
export function PropertyDetails() {
  ...
  return <main className="details-page">
    ...
    <section className="details-content"><div className="container">
      ...
      <div className="details-actions"><button onClick={share}><Share2 /> Compartilhar</button><button onClick={copyLink}><Copy /> Copiar link</button><a className="details-actions__whatsapp" href={`https://wa.me/5547999999999?text=${whatsappText}`} target="_blank" rel="noreferrer"><MessageCircle /> Enviar por WhatsApp</a>{feedback && <span role="status">{feedback}</span>}</div>
