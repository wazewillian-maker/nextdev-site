...
const reviews = [
  ...
  ['André e Luciana', 'Curitiba, PR', 'A curadoria para nossa casa de temporada foi precisa. Visitamos poucas opções, todas alinhadas ao que buscávamos, e fechamos com absoluta segurança.'],
  ['Ricardo Monteiro', 'São Paulo, SP', 'Comprei à distância e recebi acompanhamento em cada etapa, da avaliação documental à entrega das chaves. Atendimento realmente diferenciado.'],
  ['Paula Schneider', 'Itapema, SC', 'A equipe cuidou da locação anual do meu apartamento com agilidade, transparência e excelente comunicação. Uma experiência muito profissional.'],
]
